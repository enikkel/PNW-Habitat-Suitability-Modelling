...
shiny_geranium_issuesclean <- shiny_geranium_gbifsearch %>%
...
Geranium_data <- shiny_geranium_issuesclean$data[ , c("species", "decimalLongitude", "decimalLatitude", 
